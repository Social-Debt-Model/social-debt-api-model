...
def calculate_batch_sdi(issues_data: dict) -> dict:
    ...
    def aggregate_issue(group):
        ...
        return pd.Series({
            ...
            "dominant_macrocauses": macro_counter.most_common(),
            "dominant_microcauses": micro_counter.most_common(),
            "dominant_microcause_types": type_counter.most_common(),
            "dominant_community_smells": smell_counter.most_common(),
            "dominant_risks": risk_counter.most_common(),
            "dominant_preventive_strategies": prev_counter.most_common(),
            "dominant_effects": eff_counter.most_common(),
            "dominant_corrective_strategies": corr_counter.most_common(),
            "dominant_indicators": ind_counter.most_common(),
            "dominant_metrics": met_counter.most_common(),
