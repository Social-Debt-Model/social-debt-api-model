...
from app.use_cases.preprocessing.noise_filtering import es_hard_noise, es_soft_noise
...
async def process_single_comment(text: str, author: str = "") -> dict:
    ...
    is_soft = es_soft_noise(cleaned_text)
    is_noise = is_hard or is_soft
    noise_level = "hard_noise" if is_hard else "soft_noise" if is_soft else "useful"
